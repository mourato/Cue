//
//  CueAreaStylePreviewButton.swift
//  Notinhas
//
...
struct CueAreaStylePreview: View {
    let style: CueAreaStyle
    let color: Color
...
struct CueAreaStylePreviewButton: View {
    let style: CueAreaStyle
    let isSelected: Bool
    let color: Color
    let action: () -> Void
    ...
    var body: some View {
        Button(action: action) {
            CueAreaStylePreview(style: style, color: color)
...
private struct CueHatchPreview: View {
    let color: Color
...
extension AnnotationShapeFillStyle {
    var localizedName: String {
        switch self {
        case .outline:
            CueL10n.areaStyleOutline
        case .solid:
            L10n.AnnotateUI.shapeStyleSolid
        case .tinted:
            CueL10n.areaStyleTinted
        case .hatched:
            CueL10n.areaStyleHatched
        }
    }
}
