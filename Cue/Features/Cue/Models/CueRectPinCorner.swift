...
nonisolated enum CueRectPinCorner: String, Codable, Equatable, CaseIterable, Sendable {
    case topLeft
    case topRight
    case bottomLeft
    case bottomRight
    ...
    static func fromDrag(start: CGPoint, end: CGPoint) -> CueRectPinCorner {
    ...
    func rotated(clockwise: Bool) -> CueRectPinCorner {
        if clockwise {
            switch self {
