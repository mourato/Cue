...
nonisolated struct CueVisualNote: Codable, Equatable, Identifiable {
    ...
    let id: UUID
    var text: String
    var target: CueNoteTarget
    var color: RGBAColor
    var areaStyle: CueAreaStyle
    ...
    init(from decoder: Decoder) throws {
        ...
        target = try container.decode(CueNoteTarget.self, forKey: .target)
