...
//
    ...
    private struct VideoEditorToolbarSectionWidthKey: PreferenceKey {
        static let defaultValue: [VideoEditorToolbarSection: CGFloat] = [:]
    ...
    struct VideoEditorToolbarView: View {
        ...
        private var fileActionsGroup: some View {
            HStack(spacing: 4) {
                ...
                .help(state.isVideoInfoSidebarVisible ? L10n.VideoEditor.hideVideoInfoHint : L10n.VideoEditor
                    .showVideoInfoHint)
        ...
        private var leftSidebarToggleButton: some View {
            ...
            .help(state.isLeftSidebarVisible ? L10n.VideoEditor.hideLeftSidebarHint : L10n.VideoEditor
                .showLeftSidebarHint)
        }
        ...
        private var rightSidebarToggleButton: some View {
            ...
            .help(state.isRightSidebarVisible ? L10n.VideoEditor.hideRightSidebarHint : L10n.VideoEditor
                .showRightSidebarHint)
        }
