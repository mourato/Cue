...
enum PreferencesKeys {
    ...
    static let recordingDimScreenWhileRecording = "recording.dimScreenWhileRecording"
    static let recordingShowCountdown = "recording.showCountdown"
    static let recordingDoNotDisturbWhileRecording = "recording.doNotDisturbWhileRecording"
    static let recordingMaxResolution = "recording.maxResolution"
    static let recordingScaleRetinaTo1x = "recording.scaleRetinaTo1x"
    static let recordingAudioMono = "recording.audioMono"
    static let recordingAudioTracks = "recording.audioTracks"
    static let recordingGifFrameRate = "recording.gif.frameRate"
    static let recordingGifMaxWidth = "recording.gif.maxWidth"
    static let recordingGifOptimize = "recording.gif.optimize"
    static let recordingGifQuality = "recording.gif.quality"
