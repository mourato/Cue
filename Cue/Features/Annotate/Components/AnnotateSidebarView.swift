    ...
    private var presetDropdownContent: some View {
        VStack(alignment: .leading, spacing: 0) {
            Button {
                ...
                .font(Typography.labelSmall)
                .foregroundColor(state.isCanvasPresetLimitReached ? SidebarColors.labelSecondary : SidebarColors
                    .labelPrimary)
                .padding(.horizontal, Spacing.sm)
                .padding(.vertical, 7)
            ...
            Button {
                ...
                HStack(spacing: Spacing.xs) {
                    Image(systemName: state.selectedCanvasPresetId == preset.id ? "checkmark" : "circle")
                        .font(.system(size: 10, weight: .semibold))
                        .foregroundColor(state.selectedCanvasPresetId == preset.id ? .accentColor : SidebarColors
                            .labelSecondary
                            .opacity(0.7))
