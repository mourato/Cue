...
@MainActor
enum CueConfigurationDefaultDocument {
    ...
    private static func writeCapture(_ writer: inout SimpleTOMLWriter) {
        ...
        writer.value("show_selection_snap_guides", CaptureSelectionSnappingConfiguration.defaultShowSnapGuides)
    ...
    private static func writeUploads(_ writer: inout SimpleTOMLWriter) {
        ...
        writer.value("image_format", CueUploadImageFormat.webp.rawValue)
        writer.value("maximum_dimension", CueUploadEncodingSettings.defaultMaximumDimension)
        writer.value("jpeg_quality", CueUploadEncodingSettings.defaultJPEGQuality)
    }
    ...
    private static func writeShortcuts(_ writer: inout SimpleTOMLWriter) {
        ...
        writer.value("key", CueConfigurationShortcutCodec.exportKey(defaultEditorShortcut))
        writer.stringArray("modifiers", CueConfigurationShortcutCodec.exportModifiers(defaultEditorShortcut))
    ...
    private static func writeShortcutValues(_ writer: inout SimpleTOMLWriter, shortcut: ShortcutConfig?) {
        ...
        writer.value("key", CueConfigurationShortcutCodec.exportKey(shortcut))
        writer.stringArray("modifiers", CueConfigurationShortcutCodec.exportModifiers(shortcut))
    }
