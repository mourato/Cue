...
final class AppLanguageManager: ObservableObject {
    ...
    nonisolated static func normalizedLanguageIdentifier(from identifier: String?) -> String? {
    ...
    private nonisolated static func normalizedIdentifier(from identifier: String) -> String? {
