...
@MainActor
final class CueConfigurationAutoImporterTests: XCTestCase {
    private var tempDirectory: URL!

    override func setUpWithError() throws {
        try super.setUpWithError()
        tempDirectory = FileManager.default.temporaryDirectory
            .appendingPathComponent("CueConfigurationAutoImporterTests-\(UUID().uuidString)", isDirectory: true)
    ...
    func testAutoImportAppliesChangedConfigFileAndStoresSignature() throws {
        ...
        let result = CueConfigurationAutoImporter.applyIfNeeded(from: fileURL, defaults: defaults)
        ...
        let secondResult = CueConfigurationAutoImporter.applyIfNeeded(from: fileURL, defaults: defaults)
