...
@MainActor
final class CueConfigurationImporterTests: XCTestCase {
    ...
    func testImportRejectsInvalidEnumValues() {
        ...
        """
        let result1 = CueConfigurationImporter.importTOML(sourceInvalidTrackpad, defaults: defaults)
        ...
        """
        let result2 = CueConfigurationImporter.importTOML(sourceInvalidLeftAction, defaults: defaults)
        ...
        """
        let result3 = CueConfigurationImporter.importTOML(sourceInvalidAnim, defaults: defaults)
    ...
    func testValidateLegacyCloudActionsIgnoresRetiredValues() {
        ...
        XCTAssertFalse(CueConfigurationImporter.validateTOML(source).contains { $0.severity == .error })
    }
    ...
    func testImportLegacyCloudEnabledActionsPreservesDefaults() {
        ...
        let result = CueConfigurationImporter.importTOML(source, defaults: UserDefaultsFactory.make())
