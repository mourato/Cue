...
@MainActor
final class CueImageKitUploadServiceTests: XCTestCase {
    ...
    private func makeService() -> CueImageKitUploadService {
        let configuration = URLSessionConfiguration.ephemeral
        configuration.protocolClasses = [MockImageKitURLProtocol.self]
        return CueImageKitUploadService(session: URLSession(configuration: configuration))
    }

    private func makeImage() -> CueEncodedImage {
