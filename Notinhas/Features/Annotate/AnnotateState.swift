...
final class AnnotateState: ObservableObject {
    ...
    private func sanitizedSharedAnnotationParameterDefaults(
        ...
        SharedAnnotationParameterDefaults(
            ...
            watermarkRotationDegrees: defaults.watermarkRotationDegrees
                .map(AnnotationProperties.clampedRotationDegrees(_:)),
    ...
    private func persistAnnotationToolProperties() {
        let payload = annotationToolProperties
            .reduce(into: [String: PersistedAnnotationProperties]()) { result, entry in
    ...
    var quickCornerRadiusBinding: Binding<CGFloat> {
        Binding(
            get: { [weak self] in
                ...
                return quickSelectionTargets(matching: { $0.toolType.supportsQuickCornerRadius }).first?.properties
                    .cornerRadius
