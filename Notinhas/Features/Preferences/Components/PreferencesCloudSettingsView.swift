                        ...
                        Button(action: startGoogleAuthorization) {
                            HStack(spacing: 6) {
                                ...
                                Text(isAuthorizing ? L10n.CloudSettings
                                    .googleAuthorizing :
                                    (authorizationSuccess ? L10n.CloudSettings.googleAuthorized : L10n.CloudSettings
                                        .googleAuthorize))
                            }
                        }
                        .disabled(googleClientId.trimmingCharacters(in: .whitespacesAndNewlines)
                            .isEmpty || googleClientSecret
    ...
    private func startGoogleAuthorization() {
        ...
        Task {
            do {
                ...
                googleUserEmail = try await GoogleDriveOAuthService.shared
                    .fetchUserEmail(accessToken: tokens.accessToken)
    ...
    private func saveAndTest() {
        ...
        let config = CloudConfiguration(
            ...
            endpoint: isGoogle ? nil :
                (endpoint.trimmingCharacters(in: .whitespaces).isEmpty ? nil : endpoint
                    .trimmingCharacters(in: .whitespaces)),
        ...
        Task {
            ...
            let trimmedSecretKey = isGoogle ? googleClientSecret
                .trimmingCharacters(in: .whitespacesAndNewlines) : secretKey
                .trimmingCharacters(in: .whitespacesAndNewlines)
