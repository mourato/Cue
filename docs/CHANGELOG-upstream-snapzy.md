# Archived upstream Snapzy changelog

Frozen upstream Snapzy and pre-fork history. The live Notinhas changelog is [CHANGELOG.md](../CHANGELOG.md) at the repository root.

Do not edit this file for new Notinhas releases.
